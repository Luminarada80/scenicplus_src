...
def add_parser_for_search_space(subparser:argparse._SubParsersAction):
    ...
    def search_space(arg):
        ...
        print(f'multiome_mudata_fname = {arg.multiome_mudata_fname}')
        print(f'gene_annotation_fname = {arg.gene_annotation_fname}')
        print(f'chromsizes_fname = {arg.chromsizes_fname}')
        print(f'out_fname = {arg.out_fname}')
